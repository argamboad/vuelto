...
| `tools/README.md` | **Operator tools runbook** (hidden — no page/route): `snapshot-household.sql` carries one household to another server (what comes across, prerequisites, step by step, dry run, troubleshooting) |
