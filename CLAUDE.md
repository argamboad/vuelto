...
| `docs/QA_TEST_PLAN.md` | Manual QA plan — step-by-step tests across web + all four native platforms (167 cases: smoke + regression + §14a v3-audit adversarial/tenant-isolation + §13c native release checklist) |
